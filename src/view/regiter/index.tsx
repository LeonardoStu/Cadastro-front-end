    ...
    return <>
        <form onSubmit={handleSubmit} className={style.form}>
            ...
            <div className={style.divInput}>
                {/* firstname */}
                <label className={style.label} htmlFor="name">Primeiro nome:</label>
                <input className={style.input} type="text" id="name" placeholder="Digite seu primeiro nome" value={name} onChange={(e) => setName(e.target.value)} required/>
            </div>
